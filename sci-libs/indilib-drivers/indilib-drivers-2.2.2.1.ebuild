...
RDEPEND="
	...
	indilib_drivers_astarbox? ( ~sci-libs/indilib-driver-astarbox-${PV} )
	indilib_drivers_astroasis? (
		amd64? ( ~sci-libs/indilib-driver-astroasis-${PV} )
	)
	indilib_drivers_atik? ( ~sci-libs/indilib-driver-atik-${PV} )
	indilib_drivers_atik-efw? ( ~sci-libs/indilib-driver-atik-efw-${PV} )
	...
	indilib_drivers_celestron-origin? ( ~sci-libs/indilib-driver-celestron-origin-${PV} )
